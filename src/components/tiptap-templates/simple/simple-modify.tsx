...
import { handleModify } from '@/lib/articleUtils';
...
type ModifyBodyType = {
  content: string,
  initTitle: string,
  setIsModify : (type: boolean) => void,
  initImages : string[],
  inittags : string[],
  articleId : string
}

export function SimpleModify(modifybody:ModifyBodyType) {
  const {content, initTitle, setIsModify, inittags, initImages, articleId} = modifybody;
  const {user} = useAuth();
    ...
    <div>
            ...
            <div className="simple-editor-wrapper">
              ...
              <EditorContext.Provider value={{ editor }}>
                ...
                <button
                  onClick={modifyPost}
                  className=" mr-4 my-5 w-28 h-12 md:w-36 text-sm md:text-3xl md:h-16 rounded-xl bg-[#6083FF] font-black  text-white">
                  수정하기
              </button>
